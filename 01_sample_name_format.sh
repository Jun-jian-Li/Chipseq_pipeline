...
echo "对于自测数据:数据的命名一定要是A1_1.fastq.gz 这种才运行脚本进行转换,随后再手动确认那些样本是Input组与IP组,最终的样本规则为 A1_Input_R1.fq.gz(双端)";
...
echo "Chipseq 的数据需要整理成: Sample_IP.fq.gz/Sample_Input.fq.gz "
